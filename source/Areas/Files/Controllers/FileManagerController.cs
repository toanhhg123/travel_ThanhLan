...
namespace source.Areas.Files.Controllers
{
    [Area("files")]
    public class FileManagerController : Controller
    {
        ...
        public FileManagerController(ILogger<FileManagerController> logger, IWebHostEnvironment env)
        {
            _logger = logger;
            _env = env;
        }
        ...
        private Connector GetConnector()
        {
            ...
            string urlthumb = $"{uri.Scheme}://{uri.Authority}/files/filemanager/thumbs";

            Console.WriteLine(urlthumb);
